...
const Hero = () => {
  ...
  return (
    <section className="container mx-auto flex flex-col items-center text-center pt-4 pb-20">
      <motion.div
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4 mt-4">Design Your Style<br />With <span className="text-yellow-500">Yanshay</span></h1>
